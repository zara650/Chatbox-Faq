...
<svg width="160" height="160" viewBox="0 0 160 160" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <radialGradient id="orb" cx="38%" cy="32%" r="65%">
      ...
      <stop offset="45%"  stop-color="#3b82f6" stop-opacity="1"/>
    ...
    <filter id="shadow">
      <feDropShadow dx="0" dy="8" stdDeviation="12" flood-color="#3b82f6" flood-opacity="0.4"/>
    </filter>
  </defs>
  ...
  <text x="80" y="76" text-anchor="middle" font-family="Poppins, sans-serif" font-weight="700"
        font-size="14" fill="#60a5fa" filter="url(#glow)" letter-spacing="2">FAQ</text>
  <text x="80" y="94" text-anchor="middle" font-family="Poppins, sans-serif" font-weight="700"
        font-size="13" fill="#93c5fd" filter="url(#glow)" letter-spacing="3">.ai</text>
  <line x1="80" y1="132" x2="80" y2="148" stroke="#3b82f6" stroke-width="1.5" opacity="0.6"/>
  <line x1="68" y1="142" x2="92" y2="142" stroke="#3b82f6" stroke-width="1.5" opacity="0.6"/>
  <circle cx="68" cy="142" r="2" fill="#3b82f6" opacity="0.8"/>
  <circle cx="92" cy="142" r="2" fill="#3b82f6" opacity="0.8"/>
</svg>
